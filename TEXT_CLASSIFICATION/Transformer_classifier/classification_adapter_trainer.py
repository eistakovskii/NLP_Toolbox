from transformers import AutoTokenizer, TrainingArguments, Trainer, EarlyStoppingCallback, IntervalStrategy, DataCollatorWithPadding
...
if __name__ == "__main__":
    ...
    # Add a new adapter
    model.add_adapter("bin_class")
    # Add a matching classification head
    model.add_classification_head("bin_class", num_labels=2, id2label = id2label)
    # Activate the adapter
    model.train_adapter("bin_class")
    ...
    print(f"\nTHE BEST ADAPTER LOCATED AT {trainer.state.best_model_checkpoint} WITH F1 {trainer.state.best_metric}\n")
