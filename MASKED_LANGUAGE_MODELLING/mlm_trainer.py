...
import os
import torch
from transformers import DataCollatorForLanguageModeling, AutoModelForMaskedLM, TrainingArguments, Trainer, IntervalStrategy, EarlyStoppingCallback, AutoTokenizer
import argparse
import random
import numpy as np
import math
...
if __name__ == "__main__":
    ...
    main_data = main_data.train_test_split(test_size=0.2)
